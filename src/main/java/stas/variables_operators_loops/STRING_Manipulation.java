...
//		anotherFish = numFish + 1;  // нет автоматического преобразовани€ в String из int других примитивов
//		anotherFish = 'd';			//даже из char
//		anotherFish = numFish2; 	//нет автоматического преобразовани€ в String из Integer и других оберток
		
		System.out.println(anotherFish + " " + fishType); // null tuna   
		//почему дл€ null-ссылок печатаетс€ "null"
...
//		}
		...
		System.out.println("gamer".replace('g', 'd') == "gamer"); // но здесь false   !!!!!!!!!!!!!!!!!!!!!!!!!
		System.out.println("gamer".replace("g", "g") == "gamer"); // и здесь тоже false
	//если в String.replace(char, char) первый и второй ј–√”ћ≈Ќ“џ —ќ¬ѕјƒјё“, то возвращаетс€
	//
