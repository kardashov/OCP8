...
//     return � ; �����������, �.�. ���� {}
        ...
        print(() -> true); // 0 parameters  return ������������, �.�. ��� {}
...
//    Since Java doesn�t allow us to redeclare a local variable, the
//    following is an issue:
        (a, b) -> {
            int a = 0;
            return 5;
        } // DOES NOT COMPILE   We tried to redeclare a, which is not allowed.
