...
import stas.access.other.pack.SubClassFromOtherPackage;

public class SubClassFromSamePackage extends MySuperClass {
...
public static void main(String[] args) {
	...
	// о как!!!
	SubClassFromSamePackage myVar = new SubClassFromSamePackage();
