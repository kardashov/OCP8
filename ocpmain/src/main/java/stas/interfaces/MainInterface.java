...
public abstract interface MainInterface {
    ...
    int MIN_SOMETHING; // DOES NOT compile �������� ������ ������ ���� ���������, �.�. ���� final
...
////////////////	code doesn�t compile, as the class defines two methods with the same name and
...
class Cat implements Walk, Run { // DOES NOT COMPILE, �.�. ���� 2 ���������� ��������� ������ �� ������ �����������
