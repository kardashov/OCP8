...
//4. If the parent doesnТt have a no-argument constructor and the child doesnТt define any
//constructors, the compiler will throw an error and try to insert a default no-argument
//constructor into the child class.
//5. If the parent doesnТt have a no-argument constructor, the compiler requires an explicit
...
public class MainClassAnimal {
	...
	public MainClassAnimal(int age) {
		// вызова super() нет, но он автоматически добавл€етс€ компил€тором
		// если в суперклассе нет конструктора без параметров, 
		this.age = age;
		this.name = null;
	}
}
