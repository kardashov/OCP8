...
//The runner waits until the countdown timer gets to zero and then starts running
class Runner extends Thread {
    ...
    public void run() {
        try {
            timer.await();// wait for the timer count down to reach 0
