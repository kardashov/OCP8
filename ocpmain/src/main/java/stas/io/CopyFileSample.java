...
public class CopyFileSample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // new File("//home//st//Calibre LibraryCopy.zip")); //Time taken:
        // 1929seconds

        myCopyBuffered(new File("//home//st//Calibre Library.zip"), new File("//home//st//Calibre LibraryCopy.zip")); // Time
        // taken:
        // 34
        // seconds
    ...
    public static void myCopy(File src, File dest) throws FileNotFoundException, IOException {
        ...
        try (InputStream source = new FileInputStream(src); OutputStream destination = new FileOutputStream(dest)) {
            int buffer;
