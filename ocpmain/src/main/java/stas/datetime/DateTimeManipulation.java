...
//		variable so they are not lost.
        ...
        date = LocalDate.of(2020, Month.JANUARY, 20);
//		date = date.plusMinutes(1); // DOES NOT COMPILE � LocalDate ��� �����!
...
//		ldt = LocalDateTime.from(anotherDate); // Runtime EXCEPTION! ������ ������� localDateTime �� LocalDate
...
//		����� 		Duration.ofDays(3); ��������� Days � Hours!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//		Duration 	�� ����� ���� DAY, ������ hours minutes � seconds
...
//		https://docs.oracle.com/javase/8/docs/api/java/time/format/DateTimeFormatter.html#patterns
        ...
        try {
            ...
            //�������, �� ���������� ��������� ��������������, ������ ���� ��������� � ' '
            // �������� "'�������' dd' 'MM' 'yyyy"
            LocalDate ddf = LocalDate.parse(input, formatter); //����� parse ������� LocalDate ���������� LocalDate

            TemporalAccessor ta = formatter.parse(input); //����� parse ���������� ���������� TemporalAccessor

            LocalDate dateFromTempAccessor = LocalDate.from(ta);  // ������� ����� ������ LocalDate �� TemporalAccessor
...
/*		Another way to look at it is that there is one day in March that is 23 hours long and one
        ...
        System.out.println(dateTime11);    //2016�03�13T01:30�05:00[US/Eastern]
        dateTime11 = dateTime11.plusHours(1);
        System.out.println(dateTime11);    //2016�03�13T03:30�04:00[US/Eastern]
        ...
        System.out.println(dateTime11); //2016�11�06T01:30�04:00[US/Eastern]
        dateTime11 = dateTime11.plusHours(1);
        System.out.println(dateTime11); //2016�11�06T01:30�05:00[US/Eastern]
        dateTime11 = dateTime11.plusHours(1);
        System.out.println(dateTime11); //2016�11�06T02:30�05:00[US/Eastern]
