...
//	lesson 136  and 169
    ...
    public void methodPublic() {
        System.out.println("inside MySuperClass.methodPublic method ");
    }

    ;

    protected void methodProtected() {
        System.out.println("inside MySuperClass.methodProtected method ");
    }

    ;

    void methodPackage() {
        System.out.println("inside MySuperClass.methodPackage method ");
    }

    ; //package

    private void methodPrivate() {
        System.out.println("inside MySuperClass.methodPrivate method ");
    }
